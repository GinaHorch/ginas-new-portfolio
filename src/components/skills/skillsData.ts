...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: "Accessibility (WCAG)", level: "production" },
  ...
  },
  {
    ...
    // Levels here trace to .claude/context/diploma-practical-labs.md. Hands-on lab
    // work is "practical"; coursework-only topics stay at "working". A lab is not
    // production, so nothing here is "production" on the strength of study alone.
    skills: [
      ...
      { name: "Application security (OWASP Top 10)", level: "practical" },
      { name: "Microsoft Defender, Intune & Entra", level: "practical" },
      { name: "Endpoint security & device compliance", level: "practical" },
      { name: "Network security & firewalls", level: "practical" },
      { name: "Linux security fundamentals", level: "practical" },
      { name: "Nmap & network reconnaissance", level: "practical" },
  ...
  },
  {
    ...
    skills: [
      { name: "Cloudflare", level: "production" },
      { name: "Cloudflare Workers / Wrangler", level: "production" },
      ...
      { name: "AWS (IAM, EC2, S3, VPN, encryption)", level: "practical" },
      { name: "Virtualisation (UTM, VirtualBox)", level: "practical" },
    ],
  },
  {
